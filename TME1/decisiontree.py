...
#Calculer pour chaque attribut binaire l'entropie et l'entropie conditionnelle
...
datax = data[: ,:32] #l'attribut rating n y est pas
...
for i in range (1,30):
    #set_entropy.append(entropy(data[:,i-1:i]))
    print(entropy(data[:,i-1:i].))
'''